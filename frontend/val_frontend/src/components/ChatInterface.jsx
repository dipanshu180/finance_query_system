...
import { Send, Bot, User, Sparkles, Zap, RefreshCw, MessageCircle } from "lucide-react";
...
const ChatInterface = () => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      if (query.includes('top') && (query.includes('portfolio') || query.includes('investor') || query.includes('client'))) {
        newQueryType = 'topPortfolios';
        setShowVisualization(true);
      } else if (query.includes('manager') && (query.includes('breakdown') || query.includes('portfolio') || query.includes('performance'))) {
        newQueryType = 'managerBreakdown';
        setShowVisualization(true);
        ...
        setShowVisualization(true);
      } else if (query.includes('portfolio') && (query.includes('value') || query.includes('breakdown'))) {
        newQueryType = 'topPortfolios';
        setShowVisualization(true);
      } else if (query.includes('client') && (query.includes('list') || query.includes('show'))) {
        newQueryType = 'topPortfolios';
        setShowVisualization(true);
      }
